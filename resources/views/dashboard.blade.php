        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <h3 class="mt-8 mb-4 text-xl font-semibold">Frequently Asked Questions</h3>
                    <!-- Add your frequently asked questions list here -->
                    <form action="" method="post">
                        @csrf
                        <div class="mb-6">
                            <label for="title" class="block mb-2">Title: </label>
                        ...
                        <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:bg-blue-600">Answer Question</button>
